...
// const mssgInput = document.getElementById('mssgIp');
// const mssgContainer = document.querySelector(".container");


// const append=(message,position)=>{
//     const mssgElement = document.createElement('div');
//     mssgElement.innerText=message;
//     mssgElement.classList.add('message');
//     mssgElement.classList.add(position);
//     mssgContainer.append(mssgElement);

// }

// form.addEventListener('submit',(e)=>{
//     e.preventDefault();
//     const message=mssgInput.value;
